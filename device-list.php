        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 main-content ">
            <div class="container-fluid">
                ...
                <div class="col-12 p-0 d-flex justify-content-end mt-2">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addDeviceModal">Add Device</button>
                </div>
                <div class="row">
                    <div class="col-12 p-0">
                            ...
                            <table class="table table-striped styled-table w-100">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="bg-logo-color text-white col-1">Last Update</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-info btn-sm" onclick="openLightsModal(this)">10</button>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="https://www.google.com/maps?q=17.467754,%2078.603072" target="_blank">Location</a></td>
                                        <td>
                                            <button class="btn btn-info btn-sm" onclick="openLightsModal(this)">15</button>
                                        </td>
                                        <td><i class="bi bi-trash-fill text-danger" onclick="deleteRow(this)"></i></td>
                                    </tr>
