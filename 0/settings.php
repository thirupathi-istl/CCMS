                ...
                <div class="col-md-6 p-0 pe-md-2 mt-2">
                    <div class="card">
                        <div class="card-header bg-primary bg-opacity-25 fw-bold">
                            ...
                            <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-title="Info" data-bs-content="Update the max-min voltage thresholds for each phase"> <i class="bi bi-info-circle"></i>
                            </a>
                        </div>
                ...
                <div class="col-md-6 p-0 ps-md-2  mt-md-2 mt-3">
                    <div class="card h-100">
                        <div class="card-header bg-primary bg-opacity-25 fw-bold">
                            ...
                            <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-title="Info" data-bs-content="Update the max current thresholds for each phase"> <i class="bi bi-info-circle"></i>  </a>
                        </div>
                        <div class="card-body row">
                ...
                <div class="col-md-6 col-lg-3  p-0  pe-md-2">
                    <div class="card">
                        <div class="card-header bg-primary bg-opacity-25 fw-bold">
                            ...
                            <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-title="Info" data-bs-content=" Update the capacity of the installed unit."> <i class="bi bi-info-circle"></i> </a>
                        </div>
                        <div class="card-body row">
                            <div class="col-md-12 ">
                                <div class="mb-2 ms-2">
                ...
                <div class="col-md-6 col-lg-3  p-0  px-lg-2 ps-md-2 mt-md-0 mt-3">
                    <div class="card">
                        <div class="card-header bg-primary bg-opacity-25 fw-bold">
                            ...
                            <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus"  data-bs-title="Info" data-bs-content="To Update the frame Time">  <i class="bi bi-info-circle"></i>  </a>
                        </div>
                        <div class="card-body row">
