                    ...
                    <div class="card">
                        <div class="card-header bg-primary bg-opacity-25 fw-bold">
                            ...
                            <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus"
                                data-bs-title="Info"
                                data-bs-content="Update the max-min voltage thresholds for each phase"> <i
                        ...
                        <div class="card-body row">
                            <div class="col-md-6 border-end" id="maxvoltage">
                                ...
                                <div class="mb-2 mt-1 ms-3">
                                    ...
                                    <input type="text" class="form-control " id="r_phasevoltage"
                                        placeholder="Enter voltage">
                                    <label for="y_phasevoltage" class="form-label text-warning">Y Phase:</label>
                                    <input type="text" class="form-control" id="y_phasevoltage"
                                        placeholder="Enter voltage">
                                    <label for="b_phasevoltage" class="form-label text-primary">B Phase:</label>
                                    <input type="text" class="form-control" id="b_phasevoltage"
                                        placeholder="Enter voltage">
                                </div>
                            </div>
                ...
                <div class="col-md-6 p-0 ps-md-2  mt-md-2 mt-3">
                    ...
                    <div class="card h-100">
                        <div class="card-header bg-primary bg-opacity-25 fw-bold">
                            ...
                            <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus"
                                data-bs-title="Info" data-bs-content="Update the max current thresholds for each phase">
                        ...
                        <div class="card-body row">
                            <div class="col-md-12" id="maxcurrent">
                                ...
                                <div class="mb-1  ms-2">
                                    ...
                                    <input type="text" class="form-control" id="r_phasecurrent"
                                        placeholder="Enter Current">
                                </div>
                                <div class="mb-1 ms-2">
                                    <label for="y_phasecurrent" class="form-label text-warning">Y Phase:</label>
                                    <input type="text" class="form-control " id="y_phasecurrent"
                                        placeholder="Enter Current">
                                </div>
                                <div class="mb-1 ms-2">
                                    <label for="b_phasecurrent" class="form-label text-primary">B Phase:</label>
                                    <input type="text" class="form-control" id="b_phasecurrent"
                                        placeholder="Enter Current">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 p-0 pe-md-2">
                    <div class="card">
                        <div class="card-header bg-primary bg-opacity-25 fw-bold">
                            ...
                            <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus"
                                data-bs-title="Info" data-bs-content="To change the CT ratio value in the device.">
                                <i class="bi bi-info-circle"></i>
                            </a>
                        </div>
                        <div class="card-body row">
                ...
                <div class="col-md-6 p-0 ps-md-2 mt-md-0 mt-3">
                    <div class="card">
                        <div class="card-header bg-primary bg-opacity-25 fw-bold">
                            ...
                            <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus"
                                data-bs-title="Info" data-bs-content="To Update the frame Time">
                                <i class="bi bi-info-circle"></i>
                            </a>
                        </div>
                        <div class="card-body row">
                ...
                <div class="col-md-4 p-0 pe-md-2">
                    ...
                    <div class="card">
                        <div class="card-header bg-primary bg-opacity-25 fw-bold">
                            ...
                            <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus"
                                data-bs-title="Info"
                                data-bs-content="To establish the temperature threshold for all sensors">
                                <i class="bi bi-info-circle"></i>
                            </a>
                        </div>
                        <div class="card-body row">
                ...
                <div class="col-md-4 p-0 px-md-2 mt-md-0 mt-3">
                    ...
                    <div class="card">
                        <div class="card-header bg-primary bg-opacity-25 fw-bold">
                            ...
                            <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus"
                                data-bs-title="Info" data-bs-content="To receive PF alerts, update PF value.">
                                <i class="bi bi-info-circle"></i>
                            </a>
                        </div>
                        <div class="card-body row">
                ...
                <div class="col-md-4 p-0 ps-md-2 mt-md-0 mt-3">
                    ...
                    <div class="card">
                        <div class="card-header bg-primary bg-opacity-25 fw-bold">
                            ...
                            <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus"
                                data-bs-title="Info" data-bs-content="Update the capacity of the installed unit.">
                                <i class="bi bi-info-circle"></i>
                            </a>
                        </div>
                        <div class="card-body row">
                            <div class="col-md-12 " id="unit_capacity">
                                <div class="mb-2 ms-2">
                                    ...
                                    <input type="text" class="form-control" id="unit_capacity"
