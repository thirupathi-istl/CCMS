                   ...
                   <div class="card-header bg-primary bg-opacity-25 fw-bold">
                    Voltage
                        ...
                        <div class="card-body row">
                            <form class="col-md-5 " id="maxvoltage">
                            ...
                            <form class="col-md-5 " id="minvoltage">
                                <div class="fw-bold m-0"> Min Voltage (V) </div>
                                <div class="mb-2 mt-1 ms-3">
                                <label for="r_phasevoltage" class="form-label text-danger" >R Phase:</label>
                                <input type="text" class="form-control" id="r_phasevoltage" placeholder="Enter voltage">
            ...
            <div class="col-md-6 p-0">
                <div class="container">
                    ...
                    Current
                        ...
                        <div class="card-body row">
                            <form class="col-md-12" id="maxcurrent">
                ...
                <div class="container ">
                    ...
                    <div class="card-header bg-primary bg-opacity-25 fw-bold">
                       CT settings(A)
                        ...
                        <div class="card-body row">
                            <form class="col-md-12 " id="ct_ratio">
                                <div class="mb-2 ms-2">
        ...
        <div class="row mt-4">
            <div class="col-md-4 p-0">
                <div class="container">
                    ...
                    <div class="card-header bg-primary bg-opacity-25 fw-bold">
                        ...
                        <div class="card-body row">
                            <form class="col-md-12 " id="temperature">
                                <div class="mb-2 ms-2">
            ...
            <div class="col-md-4 p-0">
                <div class="container ">
                    ...
                    <div class="card-header bg-primary bg-opacity-25 fw-bold">
                        ...
                        <div class="card-body row">
                            <form class="col-md-12 " id="pf_settings">
                                <div class="mb-2 ms-2">
            ...
            <div class="col-md-4 p-0">
                <div class="container ">
                    ...
                    <div class="card-body row">
                            <form class="col-md-12 " id="unit_capacity">
                                <div class="mb-2 ms-2">
