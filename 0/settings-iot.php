                        ...
                        <div class="col-lg-3 col-md-6 p-0 mt-3 pe-md-2">
                            <div class="card">
                                <div class="card-header bg-primary bg-opacity-25 fw-bold d-flex align-items-center">
                                    ...
                                    <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-title="Info" data-bs-content="To change the deivce id."> <i class="bi bi-info-circle"></i>
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 p-0 mt-3 pe-lg-2 ps-md-2">
                            <div class="card">
                                <div class="card-header bg-primary bg-opacity-25 fw-bold d-flex align-items-center">
                                    ...
                                    <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-title="Info" data-bs-content="To change the deivce serial id."> <i class="bi bi-info-circle"></i>
                                    </a>
                                </div>
                                <div class="card-body row">
                                    <div class="mb-2 ms-2">
                        ...
                        <div class="col-lg-3 col-md-6 p-0 mt-3 px-lg-2 pe-md-2">
                            <div class="card  mb-3">
                                <div class="card-header bg-primary bg-opacity-25 fw-bold">
                                    ...
                                    <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-title="Info" data-bs-content="To change the hysteresis value."> <i class="bi bi-info-circle"></i>
                                    </a>
                                </div>
                                <div class="card-body row">
                                    <div class="mb-2 ms-2">
                        ...
                        <div class="col-lg-3 col-md-6 p-0 mt-3 ps-md-2 ">
                            <div class="card flex-grow-1">
                                <div class="card-header bg-primary bg-opacity-25 fw-bold">
                                    ...
                                    <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-title="Info" data-bs-content="To change the interval time for on/off."> <i class="bi bi-info-circle"></i>
                                    </a>
                                </div>
                                <div class="card-body row">
                        ...
                        <div class="col-sm-4 p-0 mt-3 pe-sm-3">
                            <div class="card h-100">
                                <div class="card-header bg-primary bg-opacity-25 fw-bold">
                                    ...
                                    <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-title="Info" data-bs-content="To change energy of device."> <i class="bi bi-info-circle"></i>
                                    </a>
                                </div>
                                <div class="card-body row">
                                    <div class="mb-2 ms-2">
                        ...
                        <div class="col-sm-4 p-0 mt-3 pe-sm-2">
                            <div class="card h-100">
                                <div class="card-header bg-primary bg-opacity-25 fw-bold">
                                    ...
                                    <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-title="Info" data-bs-content="To change the details of wifi."> <i class="bi bi-info-circle"></i>
                                    </a>
                                </div>
                            ...
                            <div class="h-100 ">
                                <div class="card ">
                                    <div class="card-header bg-primary bg-opacity-25 fw-bold">
                                        ...
                                        <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-title="Info" data-bs-content="Read more about device settings"> <i class="bi bi-info-circle"></i>
                                        </a>
                                    </div>
                                    <div class="card-footer d-flex justify-content-between align-items-center flex-wrap">
                                        <div class="w-100 text-center">
                                ...
                                <div class="card mt-3">
                                    <div class="card-header bg-primary bg-opacity-25 fw-bold">
                                        ...
                                        <a tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-title="Info" data-bs-content="reset the device"> <i class="bi bi-info-circle"></i>
                                        </a>
                                    </div>
                                    <div class="card-footer d-flex justify-content-between align-items-center flex-wrap">
                                        <div class="w-100 text-center">
