    ...
    <div class="container-fluid">
        <div class="row d-flex align-items-center">
            <div class="col-12 p-0">
                <p class="m-0 p-0"><span class="text-body-tertiary">Pages / </span><span>Simcom Fail Status</span></p>
            </div>
        </div>
        <?php
        ...
        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-2 mt-1">
                                    <div class="d-flex flex-column flex-sm-row w-100 justify-content-center">
                                        <div>
                                            <label for="simcom-status-date">Select Date:</label>
                                            <input type="date" class="form-control" id="simcom-status-date">
                                        </div>
                                ...
                                <div class="table-responsive rounded m-1 border"
                                    ...
                                    <table
                                        ...
                                        <tr>
                                            ...
                                            <th class="bg-logo-color text-white" scope="col">Detection</th>
                                            <th class="bg-logo-color text-white" scope="col">Network Status</th>
                                            <th class="bg-logo-color text-white" scope="col">GPRS Status</th>
                                            <th class="bg-logo-color text-white" scope="col">Posting Status</th>
                                            <th class="bg-logo-color text-white" scope="col">Power Dip</th>
                                            <th class="bg-logo-color text-white" scope="col">Status Code</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
            ...
            <script src="<?php echo BASE_PATH; ?>js_modal_scripts/office-use-js/simcom-status.js"></script>
