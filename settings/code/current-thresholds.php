...
if ($permission_check == 1) 
{
    if ($_SERVER["REQUEST_METHOD"] == "POST") 
    {
        ...
        // Prepare and execute the Current limits insertion query
            $sql_mode = "INSERT INTO `limits_current` (`device_id`, `i_r`, `i_y`, `i_b`, `date_time`, `user_mobile`, `email`, `name`, `role`) 
        ...
        // Prepare and execute the device settings insertion query
            $setting_sql = "INSERT INTO device_settings (`setting_type`, `setting_flag`) VALUES ('CURRENT', '1') 
